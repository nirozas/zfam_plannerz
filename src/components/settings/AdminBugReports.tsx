    ...
    if (error) {
        return (
            <div className="p-4 bg-rose-50 border border-rose-100 rounded-2xl flex items-center gap-3 text-rose-600">
                ...
                <button onClick={fetchReports} className="px-3 py-1 bg-rose-600 text-white text-[10px] font-black uppercase rounded-lg hover:bg-rose-700 transition-all">Retry</button>
            </div>
        );
    }
                                ...
                                <div className="flex flex-col gap-2">
                                    ...
                                    <div className="flex gap-2">
                                        <textarea
                                            ...
                                            id={`notes-${report.id}`}
                                            className="flex-1 px-4 py-2.5 bg-slate-50 border border-slate-100 rounded-xl text-xs font-medium text-slate-700 focus:ring-2 focus:ring-indigo-500 outline-none transition-all resize-none min-h-[60px]"
                                        />
                                        <button
                                            onClick={() => {
                                            ...
                                            disabled={updatingId === report.id}
                                            className="px-3 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-[10px] font-black uppercase tracking-widest transition-all shadow-md shadow-indigo-100 flex items-center justify-center min-w-[80px]"
                                        >
